...
import MjDevLight from "./MjDevLight.png";
import MjDevDark from "./MjDevDark.png";
  ...
  return (
    <>
      <nav
        className={
          darkMode
            ? "bg-white opacity-[0.9]  border-gray-200 z-50 shadow-lg md:px-8 px-1 fixed w-full top-0"
            : "bg-gray-700  opacity-[0.9]  border-gray-200 z-50 shadow-lg md:px-8 px-1 fixed w-full top-0"
        }
      >
        <div className="flex justify-between items-center py-2 md:py-4 md:px-2 pl-2 mx-auto">
          <div className="flex items-center cursor-pointer">
            <a
              ...
              className={
                darkMode
                  ? "text-xl font-medium text-decoration-none whitespace-nowrap text-black logo"
                  : "text-xl font-medium text-decoration-none whitespace-nowrap text-white logo"
              }
            >
              {darkMode ? (
                <img src={MjDevLight} alt="logo" height={10} width={120} />
              ) : (
                <img src={MjDevDark} alt="logo" height={10} width={120} />
              )}
            </a>
          </div>
